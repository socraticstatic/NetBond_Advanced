...
export function PacketLossAnalysis({ data, timeRange }: PacketLossAnalysisProps) {
  ...
  const getNetworkQualityRating = () => {
    ...
    if (stats.avg < 0.5) return { label: 'Fair', color: 'text-fw-warn', bgColor: 'bg-fw-warnLight' };
      ...
      <div className="p-6 border-b border-fw-secondary">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Signal className="h-5 w-5 text-fw-warn mr-2" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 border-b border-fw-secondary">
        ...
        <div className="space-y-4">
          ...
          {stats.avg < 0.1 ? (
            ...
            <div className="bg-fw-warnLight rounded-lg p-4 border border-fw-warn">
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-8 w-8 rounded-full bg-fw-warnLight">
                    <AlertTriangle className="h-5 w-5 text-fw-warn" />
                  </div>
                </div>
                <div className="ml-3">
                  <h5 className="text-figma-base font-medium text-fw-warn">Moderate Packet Loss Detected</h5>
                  <p className="mt-1 text-figma-base text-fw-warn">
            ...
            <div className="space-y-4">
                ...
                <div className="h-1.5 bg-fw-neutral rounded-full">
                  <div
                    className={`h-1.5 rounded-full ${
                      stats.avg < 0.5 ? 'bg-fw-success' : stats.avg < 1 ? 'bg-fw-warnLight0' : 'bg-fw-error'
                    }`}
              ...
              <div>
                ...
                <div className="h-1.5 bg-fw-neutral rounded-full">
                  <div
                    className={`h-1.5 rounded-full ${
                      stats.avg < 0.3 ? 'bg-fw-success' : stats.avg < 0.8 ? 'bg-fw-warnLight0' : 'bg-fw-error'
                    }`}
              ...
              <div>
                ...
                <div className="h-1.5 bg-fw-neutral rounded-full">
                  <div
                    className={`h-1.5 rounded-full ${
                      stats.avg < 1 ? 'bg-fw-success' : stats.avg < 2 ? 'bg-fw-warnLight0' : 'bg-fw-error'
                    }`}
