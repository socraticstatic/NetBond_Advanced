...
export function ResiliencySelection({ resiliencyLevel, onSelect, provider, type, billingChoice, onBillingChange }: ResiliencySelectionProps) {
  return (
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1">
          <BillingPreview
            ...
            type={type as any}
            redundancy={resiliencyLevel === 'maximum'}
