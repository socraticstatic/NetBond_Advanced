    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="flex items-start space-x-3 p-3 bg-fw-wash rounded-lg border border-fw-secondary">
          <UserIcon size="sm" variant="default" className="mt-0.5 flex-shrink-0" />
          <div className="min-w-0 flex-1">
            <span className="text-xs font-medium text-fw-bodyLight block mb-0.5">Members</span>
        ...
        <div className="flex items-start space-x-3 p-3 bg-fw-wash rounded-lg border border-fw-secondary">
          ...
          <div className="min-w-0 flex-1">
            <span className="text-xs font-medium text-fw-bodyLight block mb-0.5">Connections</span>
            <p className="text-sm font-semibold text-fw-heading">
      ...
      <div>
        <div className="flex items-center justify-between p-3 bg-fw-wash rounded-lg border border-fw-secondary">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-medium text-fw-bodyLight">Monthly Cost</span>
          </div>
          <div className="flex items-center space-x-2">
            <p className="text-sm font-semibold text-fw-heading">
